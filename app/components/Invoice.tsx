...
export function InvoiceItem({ invoice }: InvoiceItemProps) {
	...
	return (
		<Link
			href={`/invoice/${id}`}
			className="flex w-full cursor-pointer flex-col gap-4 rounded-lg border border-white bg-white p-4 text-shipCove outline-none ring-1 ring-transparent transition-colors duration-150 focus:ring-purple hover:border-purple active:border-purple dark:border-ebony dark:bg-ebony dark:text-white dark:hover:border-purple dark:focus:hover:border-ebony md:flex-row md:justify-between md:py-6"
		>
